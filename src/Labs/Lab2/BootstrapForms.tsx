import { FormLabel, FormGroup, FormControl, FormSelect, InputGroup } from "react-bootstrap"
...
export default function BootstrapForms(){
    return (
        <div>
            ...
            {/* Styling dropdowns with bootstraps */}
            ...
            {/* Styling Switches with bootstraps */}
            ...
            {/* Styling Range and Sliders with Bootstrap */}
            ...
            {/* Styling Responsive Forms with Bootstrap */}
                    ...
                    className="col-sm-2 col-form-label">
                        ...
                        <div className="mb-3 row">
                            ...
                            <div className="col-sm-10">
                                ...
                                id="textarea2" rows={3}></textarea><br/>
                            </div>
                        </div>
                </div> 
                {/* Another Styling Responsive Forms with Bootstraps */}
