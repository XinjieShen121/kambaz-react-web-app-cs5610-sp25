...
tag to tell browsers to render the gaps.
        ...
        <div id="wd-lists">
            ...
            My favourite recipe - Chinese tomato egg stir-fry:
            <ol id="wd-your-favorite-recipe">
                <li>Cut 2 tomatoes into small wedges.</li>
                <li>Crack 3 eggs in a bowl and beat eggs for a minute.</li>
                <li>Add half teaspoon salt and white pepper into egg.</li>
                <li>Add oil to the wok and scramble the eggs then set aside.</li>
                <li>Add oil, scallions and tomatoes to the wok. </li>
                <li>Stir-fry over high heat for 3 minute, and then add 2 teaspoons sugar, 1/2 teaspoon salt</li>
                <li>Add scrambled egg into the wok.</li>
                <li>Cook for 2 minutes and serve with steamed rice.</li>
            </ol>
        ...
        <div id="wd-forms">
            ...
            Also, visit my Github Repository
            <a href="https://github.com/XinjieShen121/kambaz-react-web-app-cs5610-sp25.git" id="wd-github"> click here </a>
