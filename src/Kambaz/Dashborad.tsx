...
// import { enroll, unenroll } from "./Courses/Enrollments/reducer"; // ✅ Import enroll actions
...
//             id="wd-add-new-course-click"
//             onClick={() => {
//               addNewCourse(); // Call function to add course
//             }}
//           >
//             Add
//           </button>
...
//         >
//           {showAllCourses ? "Show Enrolled Courses" : "Enroll"}
//         </button>
//       )}
...
import { v4 as uuidv4 } from "uuid";
import { useSelector, useDispatch } from "react-redux";
import { enroll, unenroll } from "./Courses/Enrollments/reducer"; // ✅ Keep enroll feature
